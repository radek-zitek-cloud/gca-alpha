...
This module contains configuration models and loading logic for the API Gateway.
"""
...
def get_services_config() -> Dict[str, Any]:
    ...
    services_path = config_loader.config_dir / "services.yaml"
    if services_path.exists():
        return config_loader._load_yaml_file(services_path)
    return {"services": {}}
